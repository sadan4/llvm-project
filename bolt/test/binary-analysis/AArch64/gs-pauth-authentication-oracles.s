...
// RUN: llvm-bolt-binary-analysis --scanners=pauth-auth-oracles --auth-traps-on-failure %t.exe 2>&1 | FileCheck -check-prefix=FPAC %s
// RUN: llvm-bolt-binary-analysis --scanners=pauth-auth-oracles                         %t.exe 2>&1 | FileCheck %s
